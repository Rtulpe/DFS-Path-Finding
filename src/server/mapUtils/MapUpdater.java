package server.mapUtils;

import server.blocks.EmptyBlock;
import server.blocks.FloorBlock;
import server.blocks.IBlock;
import server.blocks.ObstacleBlock;
import server.commonUtils.PositionMapper;
import server.commonUtils.RadarInfo;
